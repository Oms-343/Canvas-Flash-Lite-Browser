...
const AnimatedNumber: React.FC<{
  ...
  animate?: boolean;
}> = ({ value, prefix, prefixVisible = true, animate = true }) => {
  ...
  return (
    <span className="animated-number">
      {prefix && (
        <span
          className="animated-prefix"
          style={{ opacity: prefixVisible ? 0.7 : 0 }}
        >
          {prefix}
        </span>
      )}
        ...
        <div className="outer-header">
          ...
          <div className="outer-caption-row">
            <p className="outer-caption">
              Imagine any website, generated in real-time by Gemini 3.1
              Flash-Lite
            </p>
            {tokenCount && (
              <span
              ...
              >
                <span className={phaseClass}>
                  <span
                    className="material-symbols-outlined token-icon"
                    aria-hidden="true"
                  >
                  ...
                  <AnimatedNumber
                    value={totalTokens}
                    prefix="~"
                    prefixVisible={!!tokenCount.isEstimate}
                    animate={isLoading}
                  />
                </span>{" "}
